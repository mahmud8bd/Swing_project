...
public class ManageStaff extends javax.swing.JPanel {
    ...
    public ManageStaff() {
        initComponents();
        dft = new DefaultTableModel(new String[]{"Sl","staff_id", "fname", "lname", "father_name", "mother_name", "birthday", 
            "gender", "contact", "email", "address", "join_date", "designation", "education_level", "salary"},0);
    ...
    private void initComponents() {
        ...
        jScrollPane2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Staff Table", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        dateOfBirth.setDateFormatString(TOOL_TIP_TEXT_KEY);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            pst=con.prepareStatement("update staff set fname=?, lname=?, father_name=?, "
                    + "mother_name=?, contact=?, email=?, education_level=? Where staff_id=?");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            con=MyConnection.getConnection();
            pst=con.prepareStatement("select * from staff where staff_id=? or fname=? or lname=?");
