 ...
 * @author mahmu
 */
public class AddStaf extends javax.swing.JPanel {
    ...
    public AddStaf() {
        initComponents();
        staff_id.setText(new AutoIdGenated().autoIdGenated("staff", "staff_id", "SF-"));
    ...
    public boolean veriText() {
        ...
        if (staff_id.getText().equals("") || fname.getText().equals("")
    ...
    private void initComponents() {
        ...
        staff_id.setBackground(new java.awt.Color(204, 204, 204));
        ...
        designation.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Computer Operator", "Network Operator", "Recepsonist", "Manager" }));
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(staff_id, javax.swing.GroupLayout.DEFAULT_SIZE, 230, Short.MAX_VALUE)
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(staff_id, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabel11))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            pst = con.prepareStatement("insert into staff (staff_id, fname, lname, father_name, mother_name, "
                    + "birthday, gender, contact, email, address, join_date, designation, education_level, salary) "
                    + "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            ...
            pst.setString(12, designation.getSelectedItem().toString());
